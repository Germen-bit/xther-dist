        ...
        let culto = item
          .map((culto) => {
            if (dayjs(culto.data).quarter() === 1) {
              trimestre1 += culto.presencas.criancas.real
            } else if (dayjs(culto.data).quarter() === 2) {
              trimestre2 += culto.presencas.criancas.real
            } else if (dayjs(culto.data).quarter() === 3) {
              trimestre3 += culto.presencas.criancas.real
            } else if (dayjs(culto.data).quarter() === 4) {
              trimestre4 += culto.presencas.criancas.real
            }
