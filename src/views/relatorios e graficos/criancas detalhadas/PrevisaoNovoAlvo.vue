  ...
  <el-row justify="space-evenly">
    <el-col :span="20" class="shadow p-3 mb-2">
      ...
      <el-table :data="result" stripe style="width: 100%">
        ...
        <el-table-column label="Média de Crianças Presentes" width="180">
      ...
      this.mesECulto.forEach((result) => {
        ...
        let media = (
          result.reduce((acc, value) => {
            return acc + value.presencas.criancas.real
          }, 0) / result.length
        ).toFixed(2)
        ...
        this.cultoPorMes.push({
          ...
          media: Number(media),
          alvo: culto.presencas.criancas.alvo
        })
      })
