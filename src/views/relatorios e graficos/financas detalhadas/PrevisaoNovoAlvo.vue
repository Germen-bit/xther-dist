  ...
  <el-row justify="space-evenly">
    <el-col :span="20" class="shadow p-3 mb-2">
      ...
      <el-table :data="result" stripe style="width: 100%">
        ...
        <el-table-column label="Média de Finanças" width="180">
      ...
      this.mesECulto.forEach((result) => {
        ...
        let media = (
          result.reduce((acc, value) => {
            return acc + Number((value.financas.total).replace(',',''))
          }, 0) / result.length
        )
        ...
        this.cultoPorMes.push({
          ...
          media: this.formatter(media),
          alvo: culto.financas.alvoFinancas
        })
      })
    },
